        ...
        <Container
            ...
            <div class="w-full flex justify-end text-end lg:block lg:pt-0 pt-2 lg:py-0">
                ...
                <ul
                    ...
                    <List v-if="auth.users.length == 0" navigation="Sign Up" link="/register" />
                </ul>
            </div>
            <div class="w-full pt-8 lg:pt-0 flex lg:justify-end justify-between items-center lg:gap-6">
                ...
                <button class="flex justify-center items-center relative group">
                    ...
                    <ul
                        ...
                        <li v-if="auth.users.token" class="mb-3"><span class="mr-4"><i
                                    class="fa-regular fa-user"></i></span> {{
                    auth.users.username
                }}
                        </li>
                        <li v-else class="mb-3"><span class="mr-4"><i class="fa-regular fa-user"></i></span> John Doe
                        </li>
                        ...
                        <li v-if="auth.users.token" class="mb-3" @click="logout()"><span class="mr-4"><i
