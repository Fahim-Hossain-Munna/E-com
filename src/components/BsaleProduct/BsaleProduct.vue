...
<template >
    <div class="lg:py-20 py-10 px-2 lg:px-0">
        <Container>
            ...
            <div class="lg:flex block lg:justify-between text-start items-center mb-[60px]">
                <div>
                    <h2 class="font-inner text-4xl font-semibold tracking-[1.44px]">Best Selling Products</h2>
                </div>
