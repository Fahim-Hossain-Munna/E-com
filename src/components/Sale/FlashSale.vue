        ...
        <Container>
            ...
            <div class="block lg:flex justify-between items-center mt-10 mb-5">
                <carousel :items-to-show="4" id="fashsale" :breakpoints="breakpoints">
                    <slide v-for="(sale, index) in productData.products" :key="index">
                        <Product :imgSrc=sale.thumbnail :title=sale.title :price=sale.price
                            :discount=sale.discountPercentage :productId=sale.id />
                    </slide>
